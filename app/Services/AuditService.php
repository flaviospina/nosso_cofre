...
final class AuditService
{
    ...
    public static function describe(string $action): string
    {
        return match ($action) {
            ...
            'recurrence.updated'       => 'Recorrência alterada',
            'recurrence.paused'        => 'Recorrência pausada',
            'recurrence.resumed'       => 'Recorrência retomada',
            'recurrence.deleted'       => 'Recorrência excluída',
            'subscription.cancelled'   => 'Assinatura cancelada',
            'budget.created'           => 'Orçamento criado',
            'budget.updated'           => 'Orçamento alterado',
            'budget.deleted'           => 'Orçamento removido',
            'goal.created'             => 'Meta criada',
            'goal.updated'             => 'Meta alterada',
            'goal.contribution'        => 'Aporte em meta',
            'goal.achieved'            => 'Meta batida',
            'goal.deleted'             => 'Meta excluída',
            'savings_action.created'   => 'Ação de economia criada',
            ...
            'notifications.updated'    => 'Preferências de aviso alteradas',
            'push.subscribed'          => 'Aparelho registrado para push',
            'push.unsubscribed'        => 'Aparelho removido do push',
